  ...
  return (
    <section className="px-5 pt-16 sm:px-7 sm:pt-14">
      <div className="mx-auto max-w-[1560px]">
        ...
        <div className="mt-8 flex flex-wrap items-center gap-4 rounded-[var(--radius-lg)] bg-surface-deep p-5">
          <div className="min-w-[190px] max-w-[260px] flex-1 basis-[200px] border-b border-border-on-deep pb-4 sm:border-b-0 sm:border-r sm:pb-0 sm:pr-4.5">
            <div className="mb-2 font-display text-[17px] font-semibold leading-tight text-fg-on-deep">All Your Channels. Connected.</div>
            <div className="text-[12.5px] leading-relaxed text-fg-on-deep-faint">
          ...
          <div className="grid min-w-[300px] flex-1 basis-[620px] grid-cols-3 gap-2.5 sm:grid-cols-5">
            {INBOX_CHANNELS.map((channel) => (
              <div key={channel.label} className="flex flex-col items-center gap-2.5 rounded-2xl bg-white p-3.5 transition-colors hover:bg-[#e6f5ee]">
          ...
          <div className="flex min-w-[190px] flex-1 basis-[200px] items-center gap-3">
            <span className="flex-none text-base text-accent-on-deep">→</span>
