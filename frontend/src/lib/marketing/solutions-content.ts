...
const MODULES = {
  ...
  assistant: { name: "Business Assistant", href: "/ai#assistant" },
  reception: { name: "AI Phone Receptionist", href: "/ai#ai-receptionist" },
  multi: { name: "Multi-location", href: "/product/multi-location" },
  analytics: { name: "Analytics", href: "/product/analytics" },
  digitizer: { name: "Photo Digitizer", href: "/ai#photo-digitizer" },
