...
export const POLICY_DEFS = {
  ...
  'sales.maxDiscountPercent': { kind: 'nullableNumber', default: null, min: 0, max: 100 },
  ...
  // returns.service.ts
  'returns.refundLimit': { kind: 'nullableNumber', default: null, min: 0, max: 100_000_000 },
  ...
  'catalog.defaultLowStockThreshold': { kind: 'number', default: 5, min: 0, max: 100_000, integer: true },
  // orders.service.ts (credit sales)
  'credit.defaultLimit': { kind: 'nullableNumber', default: null, min: 0, max: 100_000_000 },
  // appointments.service.ts / public-booking.service.ts
  'bookings.minAdvanceHours': { kind: 'nullableNumber', default: null, min: 0, max: 8760, integer: true },
  'bookings.maxAdvanceDays': { kind: 'nullableNumber', default: null, min: 1, max: 730, integer: true },
  'bookings.cancellationWindowHours': { kind: 'nullableNumber', default: null, min: 0, max: 720, integer: true },
  'bookings.rescheduleWindowHours': { kind: 'nullableNumber', default: null, min: 0, max: 720, integer: true },
  'bookings.maxDailyBookings': { kind: 'nullableNumber', default: null, min: 1, max: 10_000, integer: true },
  // campaigns.service.ts
  'marketing.frequencyCapMax': { kind: 'nullableNumber', default: null, min: 1, max: 100, integer: true },
  'marketing.frequencyCapDays': { kind: 'number', default: 30, min: 1, max: 365, integer: true },
  ...
  'backup.retentionDays': { kind: 'number', default: 30, min: 1, max: 365, integer: true },
