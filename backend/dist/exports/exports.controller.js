...
let ExportsController = class ExportsController {
    ...
    generate(user, kind) {
        if (!(0, exports_constants_1.isExportKind)(kind)) {
            throw new common_1.BadRequestException(`Unknown export kind: ${kind}`);
        }
...
], ExportsController.prototype, "generate", null);
__decorate([
    (0, common_1.Post)('account-zip'),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
