...
var HelpArticlesSeedService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.HelpArticlesSeedService = void 0;
...
const ARTICLES = [
    {
        ...
        body: 'Available appointment slots are computed from your configured working hours combined with your ' +
    ...
    },
    {
        ...
        body: 'The Credit screen shows every customer who currently owes your business money (a running balance ' +
    ...
    },
    {
        ...
        body: 'Two hours after a sale or a completed appointment, the customer automatically receives a review ' +
    ...
    },
    {
        ...
        body: 'When you send a marketing campaign to a customer segment, the system checks your remaining monthly ' +
    ...
    },
    {
        ...
        body: 'Every new business gets a 14-day free trial with no card required. During the trial you have full ' +
    ...
    },
    {
        ...
        body: 'Each staff or manager account can have a commission rule: either a percentage of the sales they ' +
...
let HelpArticlesSeedService = HelpArticlesSeedService_1 = class HelpArticlesSeedService {
    prisma;
    logger = new common_1.Logger(HelpArticlesSeedService_1.name);
    constructor(prisma) {
        this.prisma = prisma;
    }
    async onModuleInit() {
        try {
            ...
            this.logger.error(`Failed to seed help articles: ${error.message}`);
        }
    }
};
exports.HelpArticlesSeedService = HelpArticlesSeedService;
exports.HelpArticlesSeedService = HelpArticlesSeedService = HelpArticlesSeedService_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], HelpArticlesSeedService);
//# sourceMappingURL=help-articles-seed.service.js.map